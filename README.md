...
> ⚠️ **نکته بسیار مهم برای کپی کامندها:** هنگام کپی کردن دستورات متنی (به ویژه در ویندوز)، مراقب باشید فرمت‌های پنهان یا ساختار لینک مرورگرها کپی نشود تا در محیط ترمینال با خطای سینتکس (`syntax error`) مواجه نشوید.
...
با استفاده از این دستور تمیز (بدون پرانتز)، اگر اتصال برقرار باشد آی‌پای خارجی و بدون فیلتر سرور سایفون به شما نمایش داده می‌شود:
```bash
